...
def extract_verdict(text: str) -> Tuple[str, str]:
    ...
    if m:
        try:
            ...
            # optional field: flip_evidence (for research manager guardrail traceability)
            _ = d.get("flip_evidence")
...
class AgentState(MessagesState):
    ...
    data_sources: Annotated[Optional[Dict[str, Any]], "DataSourceBundle from data_collector"]
