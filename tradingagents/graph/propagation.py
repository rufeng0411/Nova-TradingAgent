...
class Propagator:
    ...
    def create_initial_state(
        ...
        canon_symbol = str(instrument_context.get("symbol") or company_name).strip() or company_name.strip()
        market_context = build_market_context(canon_symbol, str(trade_date))
        ...
        state: Dict[str, Any] = {
            ...
            "company_of_interest": canon_symbol,
