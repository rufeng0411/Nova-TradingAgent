...
#   TRADINGAGENTS_API_URL (必填) 自托管 Nova-TradingAgent 根地址，例如 http://127.0.0.1:8000
...
API_URL="${TRADINGAGENTS_API_URL:?请设置 TRADINGAGENTS_API_URL（自托管 Nova-TradingAgent 根地址）}"
